...
chatComment.innerHTML += `<img src=${avatar}>` + '<br>' + FIO.value + ':' + '<br>' + comment.value + '<br>' + date + '<br>'+ '<br>';
} else {
chatComment.innerHTML += `<img src=${avatar}>` + '<br>' + 'Username' + ':' + '<br>' + comment.value + '<br>' + date + '<br>'+ '<br>';
}
});
